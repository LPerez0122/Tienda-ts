...
type HeaderProps ={
    ...
    descremenquantity : (id : Guitar ["id"]) => void
    clearCart: () => void
    isEmpty: boolean
    carTotal : number
...
export  default  function Header({cart, removeFromCart, increasequantity, descremenquantity,  clearCart,isEmpty,carTotal} : HeaderProps  ) {
                                    ...
                                    <tr key={guitar.id} >
                                        ...
                                        <td className="flex align-items-start gap-4">
                                            <button
                                                ...
                                                onClick={ ()=>  descremenquantity  (guitar.id)}
                                            >
                                                -
                                            </button>
                                               {guitar.quantity}
